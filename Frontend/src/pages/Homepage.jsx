    ...
    <div className="homepage">
      ...
      <main className="homepage-main">
        <section className="intro">
          <h2>Welcome!</h2>
          <p>
            Movies Watchlist is your personal movie companion. You can search
            for your favorite movies, add them to your watchlist, and keep track
            of what you want to watch later.
          </p>
          <p>
            The project is built with the MERN stack and uses the OMDB API to
            fetch movie data.
          </p>
        </section>
